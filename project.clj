(defproject google-webmaster-tools-bulk-outdated-content-removal-clj "0.1.0-SNAPSHOT"
                          ...
                          {:background
                           {:source-paths ["src/background"]
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/background/main.js"
                                           ...
                                           :main          google-webmaster-tools-bulk-outdated-content-removal-clj.background
                                           :optimizations :none
                                           :source-map    true}}
                           :popup
                           {:source-paths ["src/popup"]
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/popup/main.js"
                                           ...
                                           :preloads      [devtools.preload figwheel.preload]
                                           :main          google-webmaster-tools-bulk-outdated-content-removal-clj.popup
                                           :optimizations :none
                                           :source-map    true}}}}}
                          ...
                          {:content-script
                           {:source-paths ["src/content_script"]
                            :compiler     {:output-to     "resources/unpacked/compiled/content-script/main.js"
                                           ...
                                           :main          google-webmaster-tools-bulk-outdated-content-removal-clj.content-script
